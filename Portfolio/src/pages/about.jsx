...
const About = () => {
    ...
    return (
        <section className="about section" id="about">
            ...
            <div className="about_container bg-grid">
                <div className="abt-img-content abt-left">
                    {/* SVG shapes */}
                    <div className="shape_col bobSvg">
                    <div className="App">
      ...
      <circle cx="100" cy="100" fill="#939CE2" r="80" />
        <g>
          ...
          >
            ...
            <a href="https://www.linkedin.com/feed/" className="about_icons" target="_blank"><i className="bx bxl-linkedin"></i></a>
            <a href="https://github.com/Jayrane03" className="about_icons" target="_blank"><i className="bx bxl-github"></i></a>
            <a href="https://www.instagram.com/__jay__3__5/?igshid=MzNlNGNkZWQ4Mg%3D%3D"
                className="about_icons" target="_blank"><i className="bx bxl-instagram"></i></a>
            <a href="#" className="about_icons" target="_blank"><i className="bx bxl-facebook"></i></a>
        </div>
                </div>
                ...
                <div className="abt-right">
                    ...
                    <div className="abt-me">
                        <h2 className="about_subtitile">I'am Jay Rane</h2>
                        <h2 className="about_subtitile">Developer</h2>
                        <p className="about_text">
                            I have passed my 10th from K.E.S High School <br />
                            I have passed my 12th from Rizvi College of Arts Commerce and Science <br />
                            I have done my BCA course from Tilak Maharashtra Vidyapeeth , Pune <br />
                        </p>
                    </div>
                    {/* Qualities */}
                    <h3 className="about_subtitile">My Qualities</h3>
                    <p className="about_text">
                        Full Stack Development. <br />
                        I am versatile in nature.<br />
                        Love to learn new things. <br />
                        Hard Working. <br />
                    </p>
                    {/* Download button */}
